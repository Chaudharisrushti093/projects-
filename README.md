...
HTML + Profile Image → S3 Bucket → Static Website Hosting → Website URL → Browser
...
3. Added the "profile.jpeg" profile image.
4. Uploaded the website files to the S3 bucket.
5. Enabled Static Website Hosting in Amazon S3.
6. Configured the required access and permissions.
7. Accessed the hosted profile website using the S3 website endpoint.
